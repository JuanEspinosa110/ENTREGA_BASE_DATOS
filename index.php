    ...
    <div class="container" align="center">
        <fieldset class="mb-4">
            <legend><i class="fas fa-user" ></i> &nbsp; INICIO DE SESION</legend>
                <form role="form" class="form-horizontal" method="post" action="includes/inicio.php" name="form1" id="form1"  autocomplete="off">
                                ...
                                <div class="mb-4">
                                    <div class="form-outline mb-4">
                                        <label for="cargo" class="nav-link"> &nbsp;<strong>DOCUMENTO </strong></label>
                                            <input type="text" id="documento" class="form-control Input" name="documento" maxlength="11" required>
                                    </div>
                                </div>
                            </div>
                        </div>
